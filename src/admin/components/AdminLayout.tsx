...
export function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-slate-100" dir={dir} lang={locale}>
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 z-50 w-72 border-e border-slate-200 bg-white shadow-xl transition-transform duration-300 ease-in-out lg:shadow-none lg:translate-x-0 ${
          sidebarOpen ? "translate-x-0" : "-translate-x-full"
        } ${dir === "rtl" ? "end-0 start-auto border-l border-r-0" : "start-0"}`}
        dir="ltr"
      >
      ...
      {/* Main area */}
      <div style={{ [dir === "rtl" ? "marginRight" : "marginLeft"]: "18rem" }}>
        {/* Top bar */}
